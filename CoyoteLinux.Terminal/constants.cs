...
namespace CoyoteLinux.Terminal {
    public partial class Curses {
        ...
        public enum Event : long {
            ...
            Button4Pressed = unchecked((int)0x10000),
            Button4Released = unchecked((int)0x8000),
            Button4Clicked = unchecked((int)0x20000),
            Button4DoubleClicked = unchecked((int)0x40000),
            Button4TripleClicked = unchecked((int)0x80000),
            ...
            AllEvents = unchecked((int)0xfffffff),
        }
